...
// Colors
Color primary = const Color(0xFF253475);
Color secondary = const Color(0xFFF0BB21);
Color secondary2 = const Color(0xFFFDF8A3);
...
TextStyle semibold24 = regular24.copyWith(fontWeight: FontWeight.w600);
